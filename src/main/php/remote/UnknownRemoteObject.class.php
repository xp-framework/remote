...
class UnknownRemoteObject extends \lang\Object {
  ...
  public function __set($name, $value) {
    throw new \lang\IllegalAccessException('Access to undefined member "'.$this->__name.'::'.$name.'"');
  }
  ...
  public function __call($name, $args) {
    throw new \lang\IllegalAccessException('Cannot call method "'.$this->__name.'::'.$name.'" on an unknown remote object');
  }
}
